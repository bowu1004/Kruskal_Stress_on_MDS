function [ Kruskal_stress ] = Stress_VisEvaluate_BW( X,Y )
%This main function 
...
figure(9),clf;plot(val_dissim,distance_2,'bo',val_dissim,disparities_2,'r.');
...
%
% the last stress factor is the goal
%
...
% =========================================================================
%**** The following function lsqisotonic_BW is basically the same function
%of lsqisotonic in Matlab, so please give credit to Matlab. ******
